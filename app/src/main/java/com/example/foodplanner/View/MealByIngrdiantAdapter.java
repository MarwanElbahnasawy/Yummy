...
import com.example.foodplanner.Controller.Fragments.MainFragments.MealByIngrediantFragmentDirections;
...
public class MealByIngrdiantAdapter extends RecyclerView.Adapter<MealByIngrdiantAdapter.MyViewHolder> {
    ...
    public MealByIngrdiantAdapter(List<IngrdiantMealModel> meals, NavController navController) {
        this.meals = meals;
