...
public class WeekPlannerAdapter extends RecyclerView.Adapter<WeekPlannerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull WeekPlannerAdapter.ViewHolder holder, int position) {
            ...
            /* WeekPlanner Firestore part 3/4: Loading in recycler view and Removing */
 ...
 */
        ...
        /* WeekPlanner Room part 3/4: Loading in recycler view and Removing */
    ...
    public int getItemCount() {
        /* WeekPlanner Firestore part 4/4: Getting item count */
        /*
        ...
        /* Weekplanner Room part 4/4: Getting item count */
        return mealsWeekPlanner.size();
